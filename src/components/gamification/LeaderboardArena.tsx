    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="stitch-card rounded-2xl p-6 relative overflow-hidden">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="px-4 py-2 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-300 text-xs font-bold self-start sm:self-auto flex items-center gap-2">
      ...
      <div className="stitch-card rounded-2xl p-6 border-white/10 space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-bold text-white">Weekly Focus Output vs. Group Benchmark</h2>
          </div>
        ...
        <div className="space-y-3 pt-2">
          <div>
            <div className="flex justify-between text-xs mb-1">
              <span className="font-semibold text-white">You (Alex Chen)</span>
              <span className="font-mono text-violet-400 font-bold">{userEntry.weeklyHours}h / 40h target</span>
            </div>
            <div className="h-3 w-full bg-[#121316] rounded-full overflow-hidden">
              <div
          ...
          <div>
            <div className="flex justify-between text-xs mb-1">
              <span className="text-neutral-400">Cohort Average (CS & STEM Peers)</span>
              <span className="font-mono text-neutral-400">{cohortAverageWeekly}h / 40h</span>
            </div>
            <div className="h-3 w-full bg-[#121316] rounded-full overflow-hidden">
              <div
                className="h-full bg-neutral-700 rounded-full transition-all duration-700"
      ...
      {/* Leaderboard Table */}
      <div className="stitch-card rounded-2xl p-6 border-white/10">
        <h2 className="text-base font-bold text-white mb-4">Live Peer Focus Rankings</h2>
              ...
              <div
                ...
                className={`flex items-center justify-between p-3.5 rounded-xl border transition-all ${
                  entry.isCurrentUser
                    ...
                    : 'bg-[#121316] border-white/5 hover:border-white/10'
                }`}
              >
                {/* Left: Rank & User */}
                <div className="flex items-center gap-3.5">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <span className={`text-sm font-bold ${entry.isCurrentUser ? 'text-violet-300' : 'text-white'}`}>
                        {entry.name}
                      </span>
                      <span className="text-[10px] font-mono px-1.5 py-0.5 rounded bg-white/5 text-neutral-400 uppercase">
                        {entry.institution}
                      </span>
                    </div>
